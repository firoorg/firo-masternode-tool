...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.btnSelectUtxosByValue = QtWidgets.QToolButton(self.main_widget)
        self.btnSelectUtxosByValue.setObjectName("btnSelectUtxosByValue")
        self.horizontalLayout_4.addWidget(self.btnSelectUtxosByValue)
        self.btnSelectAllUtxos = QtWidgets.QToolButton(self.main_widget)
        self.btnSelectAllUtxos.setIconSize(QtCore.QSize(12, 12))
        self.btnSelectAllUtxos.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        self.btnSelectAllUtxos.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.btnSelectAllUtxos.setObjectName("btnSelectAllUtxos")
        self.horizontalLayout_4.addWidget(self.btnSelectAllUtxos)
        ...
        self.btnCancel = QtWidgets.QPushButton(WalletDlg)
        self.btnCancel.setAutoDefault(False)
        self.btnCancel.setObjectName("btnCancel")
        self.horizontalLayout_3.addWidget(self.btnCancel)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem3)
        self.btnChooseAddressAndExit = QtWidgets.QPushButton(WalletDlg)
        self.btnChooseAddressAndExit.setAutoDefault(False)
        self.btnChooseAddressAndExit.setObjectName("btnChooseAddressAndExit")
        self.horizontalLayout_3.addWidget(self.btnChooseAddressAndExit)
    ...
    def retranslateUi(self, WalletDlg):
        ...
        self.btnCancel.setText(_translate("WalletDlg", "Cancel"))
        self.btnChooseAddressAndExit.setText(_translate("WalletDlg", "Choose address and exit"))
