...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.chbFetchDataAfterStart = QtWidgets.QCheckBox(self.tabMisc)
        self.chbFetchDataAfterStart.setObjectName("chbFetchDataAfterStart")
        self.verticalLayout_2.addWidget(self.chbFetchDataAfterStart)
        self.chbShowDashFIATValue = QtWidgets.QCheckBox(self.tabMisc)
        self.chbShowDashFIATValue.setObjectName("chbShowDashFIATValue")
        self.verticalLayout_2.addWidget(self.chbShowDashFIATValue)
        ...
        self.hlLogLevel.addItem(spacerItem7)
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabDashd), _translate("ConfigDlg", "Firo network"))
        ...
        self.chbHwLedgerNanoS.setText(_translate("ConfigDlg", "Ledger Nano S/S PLUS"))
        ...
        self.chbFetchDataAfterStart.setText(_translate("ConfigDlg", "Automatically fetch network data after starting the app"))
        self.chbShowDashFIATValue.setText(_translate("ConfigDlg", "Show Firo value in FIAT"))
        ...
        self.chbBackupConfigFile.setText(_translate("ConfigDlg", "Backup config file when saving"))
        # self.chbAddRandomOffsetToVotingTime.setText(_translate("ConfigDlg", "Add random offset to a proposal vote time to improve privacy"))
        # self.label_3.setText(_translate("ConfigDlg", "offset lower bound:"))
        # self.edtVoteTimeOffsetLower.setToolTip(_translate("ConfigDlg", "Lower range of voting time offset. It can be from -720 to + 720 minutes (-+ 12h)."))
        # self.label_5.setText(_translate("ConfigDlg", "minutes"))
        # self.label_4.setText(_translate("ConfigDlg", "offset upper bound:"))
        # self.edtVoteTimeOffsetUpper.setToolTip(_translate("ConfigDlg", "Lower range of voting time offset. It can be from -720 to + 720 minutes (-+ 12h)."))
        # self.label_6.setText(_translate("ConfigDlg", "minutes"))
        ...
        self.chbShowNetworkMasternodes.setToolTip(_translate("ConfigDlg", "Shows a tab in the main window with a list of all masternodes in the Firo network"))
