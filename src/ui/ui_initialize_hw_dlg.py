...
"For an official firmware, you can uncheck this option."))
        ...
        self.label_2.setText(_translate("HwInitializeDlg", "<a href=\"https://github.com/firoorg/znode-tool-evo/blob/master/doc/hw-initialization-recovery.md\">Read the documentation on GitHub</a>"))
